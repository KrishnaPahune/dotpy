...
st.image(r"C:\Users\krish\OneDrive\Desktop\Project\AIChatBot\src\tiger.png",use_container_width=True)
...
st.markdown(
    ...
    /* Fix the input area background without extra black area */
    [data-testid="stChatInput"] textarea {
        background: linear-gradient(-45deg, #ff9a9e, #fad0c4, #fbc2eb, #a18cd1) !important;
        background-size: 400% 400%;
        animation: gradientBG 15s ease infinite;
        border: none;
    ...
    /* Ensures the parent container doesn't have extra black space */
